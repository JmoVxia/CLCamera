...
class CLCameraButton: UIView {
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        layer.frame = CGRect(origin: .zero, size: intrinsicContentSize)
        layer.colors = [#colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1).cgColor, #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1).cgColor]
